...
class Browser:
    ...
    def harvest(self, archive_name=None):
        """
    ...
    def extract(self, archive_name=None, csv_name=None, csv_header=None):
        """
        Extract data from HTML pages stored in an archive and saves it as a
        CSV file.

        :param str archive_name: name of archive where HTML pages are stored
        ...
        with ZipFile(archive_name, "r", compression=ZIP_BZIP2) as archive:
            ...
            logging.info("checking number of null values per row")
